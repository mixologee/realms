...
set exits[-25 0] 'east
set exits[-24 13] 'east
set exits[-24 0] 'west 'east
set exits[-23 13] 'west 'south
set exits[-23 12] 'north 'south
set exits[-23 11] 'north 'south
set exits[-23 10] 'north 'east
set exits[-23 5] 'east 'south
set exits[-23 4] 'south 'north
set exits[-23 3] 'south 'north
set exits[-23 2] 'south 'north
set exits[-23 1] 'south 'north
set exits[-23 0] 'west 'north 'east
set exits[-23 -8] 'east 'south
set exits[-23 -9] 'south 'north
set exits[-23 -10] 'east 'north
set exits[-22 10] 'east 'west
set exits[-22 5] 'east 'west
set exits[-22 0] 'west
set exits[-22 -7] 'south 'east
set exits[-22 -8] 'west 'north
set exits[-22 -10] 'west 'east
set exits[-21 10] 'west 'east
set exits[-21 5] 'west 'east
set exits[-21 -7] 'west 'east
set exits[-21 -10] 'west 'east
set exits[-20 10] 'west 'east
set exits[-20 5] 'west 'east 'south
set exits[-20 4] 'north 'south
set exits[-20 3] 'north 'south
set exits[-20 2] 'north 'south
set exits[-20 1] 'north 'south
set exits[-20 0] 'north 'south
set exits[-20 -1] 'north 'south
set exits[-20 -2] 'north 'south
set exits[-20 -3] 'north 'south
set exits[-20 -4] 'north 'east
set exits[-20 -7] 'west 'east
set exits[-20 -10] 'west 'east
set exits[-19 10] 'west 'east
set exits[-19 5] 'west 'east
set exits[-19 -4] 'west 'east
set exits[-19 -7] 'west 'south
set exits[-19 -8] 'north
set exits[-19 -10] 'west 'east
set exits[-18 10] 'west 'east
set exits[-18 5] 'west 'east 'south
set exits[-18 4] 'north 'south
set exits[-18 3] 'north
set exits[-18 -4] 'west 'south
set exits[-18 -10] 'west 'east 'south
set exits[-18 -11] 'north 'south
set exits[-18 -12] 'north 'east
set exits[-17 12] 'south *
set exits[-17 11] 'north 'south
set exits[-17 10] 'north 'south
set exits[-17 9] 'north 'south
set exits[-17 8] 'north 'south
set exits[-17 7] 'north 'south 'east
set exits[-17 6] 'north 'south
set exits[-17 5] 'north 'west
set exits[-17 -5] 'west 'east
set exits[-17 -10] 'west 'east
set exits[-17 -12] 'west 'east
set exits[-16 7] 'west 'east
set exits[-16 -5] 'west 'east 'south
set exits[-16 -6] 'north 'south
set exits[-16 -7] 'north 'south
set exits[-16 -8] 'north 'south
set exits[-16 -9] 'north 'south
set exits[-16 -10] 'north 'west
set exits[-16 -12] 'west 'east
set exits[-15 7] 'west 'east
set exits[-15 4] 'south 'east
set exits[-15 3] 'north 'south
set exits[-15 2] 'north 'south
set exits[-15 1] 'north 'south
set exits[-15 0] 'north 'south
set exits[-15 -1] 'north 'south
set exits[-15 -2] 'north 'south
set exits[-15 -3] 'north 'south
set exits[-15 -4] 'north 'south
set exits[-15 -5] 'north 'west 'east
set exits[-16 -12] 'west 'east
set exits[-15 7] 'west 'east
set exits[-15 4] 'west 'east
set exits[-15 -5] 'west 'east
set exits[-15 -12] 'west 'east
set exits[-14 7] 'west 'south
set exits[-14 6] 'north 'south
set exits[-14 5] 'north 'south
set exits[-14 4] 'west 'north 'south
set exits[-14 3] 'north 'south
set exits[-14 2] 'north 'south 'east
set exits[-14 1] 'north 'south
set exits[-14 0] 'north 'south 'east
set exits[-14 -1] 'north
set exits[-14 -5] 'west 'east
set exits[-14 -12] 'west 'east
set exits[-13 2] 'west 'east
set exits[-13 0] 'west 'east
set exits[-13 -5] 'west 'south
set exits[-13 -6] 'north 'south
set exits[-13 -7] 'north 'south
set exits[-13 -8] 'north 'east
set exits[-13 -12] 'west 'east
set exits[-12 2] 'west 'east
set exits[-12 0] 'west 'east
set exits[-12 -8] 'west 'east
set exits[-12 -12] 'west 'east
set exits[-11 13] 'south 'east
set exits[-11 12] 'south 'north
set exits[-11 11] 'south 'north
set exits[-11 10] 'south 'north
set exits[-11 9] 'north 'east
set exits[-11 2] 'west 'east
set exits[-11 0] 'west 'east
set exits[-11 -8] 'west 'east 'south
set exits[-11 -9] 'north *
set exits[-11 -12] 'west 'east
set exits[-10 13] 'west 'east
set exits[-10 9] 'west 'east
set exits[-10 2] 'west 'east
set exits[-10 0] 'west 'south
set exits[-10 -1] 'north 'east
set exits[-10 -8] 'west 'east
set exits[-10 -12] 'west 'east
set exits[-9 13] 'west 'east
set exits[-9 9] 'west 'east 'south
set exits[-9 8] 'north 'south
set exits[-9 7] 'north 'south
set exits[-9 6] 'north 'south
set exits[-9 5] 'north 'south
set exits[-9 4] 'north 'south
set exits[-9 3] 'north 'south
set exits[-9 2] 'north 'west
set exits[-9 -1] 'west 'east
set exits[-9 -3] 'south 'east
set exits[-9 -4] 'north 'south
set exits[-9 -5] 'north 'south
set exits[-9 -6] 'north 'east
set exits[-9 -8] 'south 'west
set exits[-9 -9] 'south 'north
set exits[-9 -10] 'south 'north
set exits[-9 -11] 'south 'north
set exits[-9 -12] 'north 'west 'east
set exits[-8 13] 'west 'south
set exits[-8 12] 'north 'south
set exits[-8 11] 'north *
set exits[-8 9] 'west 'east
set exits[-8 -1] 'west 'east
set exits[-8 -3] 'west 'east
set exits[-8 -6] 'west 'east
set exits[-8 -12] 'west 'east
~
#21
Transform Example~
0 g 100
