...
/* Defines used for email verification and registration */
#define EMAIL_SUCCESS      0
#define EMAIL_TOO_LONG     1
#define EMAIL_NO_ADDRESS   2
#define EMAIL_NO_AT_SYMBOL 3
#define EMAIL_BAD_HOST     4
#define EMAIL_BANNED       5
#define EMAIL_INVALID      6
