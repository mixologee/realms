...
#define AEDIT_PERMISSION  99999  /* arbitrary number higher than max zone vnum*/
#define HEDIT_PERMISSION  99999  /* arbitrary number higher then max zone vnum*/
#define ALL_PERMISSION    99999  /* arbitrary number higher then max zone vnum*/
...
#define NUM_ROOM_SECTORS        113

#define NUM_MOB_FLAGS           42
...
#define MAX_DUPLICATES  99999  /* when loading in zedit */
...
#define MAX_MOB_GOLD       10000000
#define MAX_MOB_EXP        15000000
...
struct oasis_olc_data {
  ...
  struct mail_edit_data *mail;   /* for the Mudmail editor   */
...
#define ZEDIT_X_COORD                   22
#define ZEDIT_Y_COORD                   23
#define ZEDIT_ZONE_FLAGS                24
#define ZEDIT_LEVELS                    25
#define ZEDIT_LEV_MIN                   26
#define ZEDIT_LEV_MAX                   27
#define ZEDIT_ZONE_CLAIM                28
...
#define MEDIT_ATTACK1                   8
#define MEDIT_ATTACK2                   9
#define MEDIT_ATTACK3                  10
...
#define CEDIT_STAMP_COST                54
#define CEDIT_OBJECT_COST               55
#define CEDIT_DRAFT_TIMEOUT             56
#define CEDIT_MIN_MAIL_LEVEL            57
#define CEDIT_MIN_FREE_LEVEL            58
#define CEDIT_MAIL_ANYWHERE             59
#define CEDIT_MAIL_ALL_PLAYERS          60
#define CEDIT_EXP_MULTIPLIER            61

/* Hedit Submodes of connectedness. */
#define HEDIT_CONFIRM_SAVE	        0
//#define HEDIT_CONFIRM_EDIT              1
//#define HEDIT_CONFIRM_ADD               2
#define HEDIT_MAIN_MENU                 1
#define HEDIT_ENTRY                     2   
#define HEDIT_KEYWORDS                  3
#define HEDIT_AKEYS                     4
#define HEDIT_MIN_LEVEL                 5
#define HEDIT_CATEGORY			6
