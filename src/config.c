...
/* Exp change limits. */
int max_exp_gain = 2000000;	/* max gainable per kill */
int max_exp_loss = 500;	/* max losable per death */
int exp_multiplier = 1; /* default to 1, multiplier of xp per kill gamewide */
...
room_vnum mortal_start_room = 6300;

/* Virtual number of room that immorts should enter at by default. */
room_vnum immort_start_room = 6045;

/* Virtual number of room that frozen players should enter at. */
room_vnum frozen_start_room = 7298;
...
room_vnum donation_room_1 = 6304;
room_vnum donation_room_2 = 7232;
room_vnum donation_room_3 = 106;
...
const char *MENU =
"\r\n"
"Do you want ANSI color turned on? (y/n): ";

const char *WELC_MESSG =
"\r\n"
"&CWelcome to Realms of Kuvia! Enjoy your stay.&n"
"\r\n\r\n";
...
/* Mudmail options */
int mail_objects_allowed = 1;            /* object mailing allowed     Yes       */
int mail_gold_allowed = 1;               /* gold mailing allowed?      Yes       */
int mail_stamp_cost = 150;               /* Stamp Cost                 150 coins */
int mail_object_cost = 30;               /* Extra Objects Cost         30 coins  */
int mail_min_level = 1;                  /* Min level that can mail    1         */
int mail_min_free_level = LVL_IMMORT;    /* Min level for free mail    Immortal  */
int mail_allow_drafts = 1;               /* Allow draft mudmails       Yes       */
int mail_draft_timeout = 28;             /* Timeout for draft mails    28 days   */
int mail_safe_mailing = 1;               /* Stop attacks and stealing  Yes       */
int mail_min_mail_anywhere = LVL_IMMORT; /* Min level that can mail from anywhere? Immortal    */
int mail_min_send_to_all = LVL_IMPL;     /* Min level that can mail all players?   Implementor */


/*email veri options*/
int password_retrieval_allowed = YES;

int disable_wilderness = TRUE;
//int disable_wilderness = FALSE;
